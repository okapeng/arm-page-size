cmd_event-plugin.o := gcc -Wp,-MD,./.event-plugin.o.d -Wp,-MT,event-plugin.o -g -Wall -fPIC -I. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o event-plugin.o event-plugin.c
