cmd_parse-filter.o := gcc -Wp,-MD,./.parse-filter.o.d -Wp,-MT,parse-filter.o -g -Wall -fPIC -I. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o parse-filter.o parse-filter.c
