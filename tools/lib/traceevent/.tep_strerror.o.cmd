cmd_tep_strerror.o := gcc -Wp,-MD,./.tep_strerror.o.d -Wp,-MT,tep_strerror.o -g -Wall -fPIC -I. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o tep_strerror.o tep_strerror.c
