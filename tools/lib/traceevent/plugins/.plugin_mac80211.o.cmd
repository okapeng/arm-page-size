cmd_plugin_mac80211.o := gcc -Wp,-MD,./.plugin_mac80211.o.d -Wp,-MT,plugin_mac80211.o -g -Wall -fPIC -I. -I.. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o plugin_mac80211.o plugin_mac80211.c
