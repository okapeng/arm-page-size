cmd_plugin_xen.o := gcc -Wp,-MD,./.plugin_xen.o.d -Wp,-MT,plugin_xen.o -g -Wall -fPIC -I. -I.. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o plugin_xen.o plugin_xen.c
