cmd_plugin_kmem.o := gcc -Wp,-MD,./.plugin_kmem.o.d -Wp,-MT,plugin_kmem.o -g -Wall -fPIC -I. -I.. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o plugin_kmem.o plugin_kmem.c
