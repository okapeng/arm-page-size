cmd_plugin_scsi.o := gcc -Wp,-MD,./.plugin_scsi.o.d -Wp,-MT,plugin_scsi.o -g -Wall -fPIC -I. -I.. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o plugin_scsi.o plugin_scsi.c
