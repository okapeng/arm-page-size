cmd_plugin_hrtimer.o := gcc -Wp,-MD,./.plugin_hrtimer.o.d -Wp,-MT,plugin_hrtimer.o -g -Wall -fPIC -I. -I.. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o plugin_hrtimer.o plugin_hrtimer.c
