cmd_plugin_function.o := gcc -Wp,-MD,./.plugin_function.o.d -Wp,-MT,plugin_function.o -g -Wall -fPIC -I. -I.. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o plugin_function.o plugin_function.c
