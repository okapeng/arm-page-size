cmd_parse-utils.o := gcc -Wp,-MD,./.parse-utils.o.d -Wp,-MT,parse-utils.o -g -Wall -fPIC -I. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o parse-utils.o parse-utils.c
