cmd_kbuffer-parse.o := gcc -Wp,-MD,./.kbuffer-parse.o.d -Wp,-MT,kbuffer-parse.o -g -Wall -fPIC -I. -I /users/ivy_wang/tools/include -D_GNU_SOURCE -D"BUILD_STR(s)=$(pound)s" -c -o kbuffer-parse.o kbuffer-parse.c
