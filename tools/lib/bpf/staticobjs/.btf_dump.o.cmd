...
staticobjs/btf_dump.o: btf_dump.c /usr/include/stdc-predef.h \
 ...
 /users/ivy_wang/tools/include/uapi/linux/btf.h btf.h \
 /usr/lib/gcc/aarch64-linux-gnu/7/include/stdarg.h hashmap.h \
 libbpf_internal.h libbpf.h /usr/include/stdio.h \
...
cmd_staticobjs/btf_dump.o := gcc -Wp,-MD,staticobjs/.btf_dump.o.d -Wp,-MT,staticobjs/btf_dump.o -g -Wall -DHAVE_LIBELF_MMAP_SUPPORT -Wbad-function-cast -Wdeclaration-after-statement -Wformat-security -Wformat-y2k -Winit-self -Wmissing-declarations -Wmissing-prototypes -Wnested-externs -Wno-system-headers -Wold-style-definition -Wpacked -Wredundant-decls -Wstrict-prototypes -Wswitch-default -Wswitch-enum -Wundef -Wwrite-strings -Wformat -Wstrict-aliasing=3 -Wshadow -Werror -Wall -fPIC -I. -I/users/ivy_wang/tools/include -I/users/ivy_wang/tools/include/uapi -fvisibility=hidden -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D"BUILD_STR(s)=$(pound)s" -c -o staticobjs/btf_dump.o btf_dump.c
