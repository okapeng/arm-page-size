...
staticobjs/netlink.o: netlink.c /usr/include/stdc-predef.h \
 ...
 /usr/include/aarch64-linux-gnu/bits/types/struct_itimerspec.h bpf.h \
 libbpf.h /usr/include/stdio.h \
 ...
 /usr/include/aarch64-linux-gnu/bits/sys_errlist.h nlattr.h

cmd_staticobjs/netlink.o := gcc -Wp,-MD,staticobjs/.netlink.o.d -Wp,-MT,staticobjs/netlink.o -g -Wall -DHAVE_LIBELF_MMAP_SUPPORT -Wbad-function-cast -Wdeclaration-after-statement -Wformat-security -Wformat-y2k -Winit-self -Wmissing-declarations -Wmissing-prototypes -Wnested-externs -Wno-system-headers -Wold-style-definition -Wpacked -Wredundant-decls -Wstrict-prototypes -Wswitch-default -Wswitch-enum -Wundef -Wwrite-strings -Wformat -Wstrict-aliasing=3 -Wshadow -Werror -Wall -fPIC -I. -I/users/ivy_wang/tools/include -I/users/ivy_wang/tools/include/uapi -fvisibility=hidden -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D"BUILD_STR(s)=$(pound)s" -c -o staticobjs/netlink.o netlink.c
