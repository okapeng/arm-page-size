...
staticobjs/bpf_prog_linfo.o: bpf_prog_linfo.c /usr/include/stdc-predef.h \
 ...
 /users/ivy_wang/tools/include/uapi/linux/bpf_common.h libbpf.h \
 /usr/lib/gcc/aarch64-linux-gnu/7/include/stdarg.h /usr/include/stdio.h \
...
cmd_staticobjs/bpf_prog_linfo.o := gcc -Wp,-MD,staticobjs/.bpf_prog_linfo.o.d -Wp,-MT,staticobjs/bpf_prog_linfo.o -g -Wall -DHAVE_LIBELF_MMAP_SUPPORT -Wbad-function-cast -Wdeclaration-after-statement -Wformat-security -Wformat-y2k -Winit-self -Wmissing-declarations -Wmissing-prototypes -Wnested-externs -Wno-system-headers -Wold-style-definition -Wpacked -Wredundant-decls -Wstrict-prototypes -Wswitch-default -Wswitch-enum -Wundef -Wwrite-strings -Wformat -Wstrict-aliasing=3 -Wshadow -Werror -Wall -fPIC -I. -I/users/ivy_wang/tools/include -I/users/ivy_wang/tools/include/uapi -fvisibility=hidden -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D"BUILD_STR(s)=$(pound)s" -c -o staticobjs/bpf_prog_linfo.o bpf_prog_linfo.c
