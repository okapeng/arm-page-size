...
staticobjs/bpf.o: bpf.c /usr/include/stdc-predef.h /usr/include/stdlib.h \
 ...
 /usr/include/strings.h /usr/include/memory.h /usr/include/unistd.h \
 ...
 /users/ivy_wang/tools/include/uapi/linux/bpf_common.h bpf.h libbpf.h \
...
cmd_staticobjs/bpf.o := gcc -Wp,-MD,staticobjs/.bpf.o.d -Wp,-MT,staticobjs/bpf.o -g -Wall -DHAVE_LIBELF_MMAP_SUPPORT -Wbad-function-cast -Wdeclaration-after-statement -Wformat-security -Wformat-y2k -Winit-self -Wmissing-declarations -Wmissing-prototypes -Wnested-externs -Wno-system-headers -Wold-style-definition -Wpacked -Wredundant-decls -Wstrict-prototypes -Wswitch-default -Wswitch-enum -Wundef -Wwrite-strings -Wformat -Wstrict-aliasing=3 -Wshadow -Werror -Wall -fPIC -I. -I/users/ivy_wang/tools/include -I/users/ivy_wang/tools/include/uapi -fvisibility=hidden -D_LARGEFILE64_SOURCE -D_FILE_OFFSET_BITS=64 -D"BUILD_STR(s)=$(pound)s" -c -o staticobjs/bpf.o bpf.c
