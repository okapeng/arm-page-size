cmd_pmu-events/jevents.o := gcc -Wp,-MD,pmu-events/.jevents.o.d -Wp,-MT,pmu-events/jevents.o  -D"BUILD_STR(s)=$(pound)s" -I/users/ivy_wang/tools/include  -c -o pmu-events/jevents.o pmu-events/jevents.c
